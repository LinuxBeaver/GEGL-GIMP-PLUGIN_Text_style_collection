...
You can test plugin without installing by pasting this syntax into Gimpꞌs GEGL graph (This graph requires another plugin ꞌssgꞌ ꞌ this filter ships with it plugins)
...
Itꞌs literally ringed bevel without the bevel and more rings; as the bevel looks bad with many rings.
...
property_int  (ringsize, _("Ring size"), 5)
  ...
  ui_range    (1, 9)
  ui_meta     ("unit", "pixel-distance")
  description (_("Control the size of the rings. This also creates gaps when bottom bevelꞌs opacity is low. "))
...
property_enum (ringshape, _("Shape of ring"),
  ...
  description (_("Shape of the Rings that internally uses Median Blurꞌs neighborhood setting (square, circle, diamond). This does not apply to 16 rings mode."))
...
/*This is a median blurꞌs radius being called to make the text larger*/
