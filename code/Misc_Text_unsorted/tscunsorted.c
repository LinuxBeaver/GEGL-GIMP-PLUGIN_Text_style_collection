...
#define g1 \
"   color-overlay value=#f40014 cubism tile-size=8  seed=334 gaussian-blur abyss-policy=none clip-extent=false  std-dev-x=3 std-dev-y=3 id=1 gimp:layer-mode layer-mode=grain-extract aux=[ ref=1 lb:bevel  bevel1=145 bevel2=92 th=0.60 azimuth=30 ] box-blur radius=1 brightness-contrast brightness=-0.11 id=3 gimp:layer-mode layer-mode=linear-light  opacity=0.10 aux=[ ref=3 lb:bevel  bevel1=145 bevel2=92 th=0.60 azimuth=4 ] opacity value=1.3 median-blur abyss-policy=none radius=1 alpha-percentile=10 "\


#define g2 \
" id=n1 gaussian-blur std-dev-x=3 std-dev-y=3 abyss-policy=none clip-extent=false lb:threshold-alpha alphadegree=0.1 color-overlay value=#52ebff id=0 gimp:layer-mode composite-mode=auto layer-mode=hardlight aux=[ ref=0 emboss depth=6  ] id=1 gimp:layer-mode layer-mode=hsl-color opacity=1 aux=[ ref=1 color-overlay value=#52ebff   ] id=2 gimp:layer-mode layer-mode=overlay opacity=0.3 blend-space=rgb-perceptual aux=[ ref=2 wind direction=bottom style=blast threshold=2 seed=0 strength=28 oilify mask-radius=2.5  lb:custom-bevel  box=1 gaus=1 depth=1 blendmode=Plus coloroverlay=#a3e9ff  ] id=3  gimp:layer-mode layer-mode=softlight  composite-mode=auto blend-space=rgb-perceptual opacity=0.90  aux=[ ref=1 lb:bevel radius1=1 ] noise-reduction iterations=4 id=4 gimp:layer-mode layer-mode=overlay opacity=0.3 blend-space=rgb-linear aux=[ ref=4 lb:edge-extract  ] softglow glow-radius=1 id=5 gimp:layer-mode layer-mode=lighten-only aux=[ ref=5 edge gray  ] mean-curvature-blur iterations=7 hue-chroma lightness=-3 gimp:layer-mode layer-mode=split opacity=0.20 aux=[ ref=n1 gaussian-blur   ]  "\


#define g3 \
" median-blur abyss-policy=none radius=25 alpha-percentile=20 cubism tile-size=5  tile-size=9 snn-mean gaussian-blur abyss-policy=none clip-extent=false color-overlay value=#f95dff median-blur abyss-policy=none  percentile=90 gaussian-blur abyss-policy=none clip-extent=false std-dev-x=4 std-dev-y=4 id=3 screen aux=[ ref=3  emboss  type=bumpmap azimuth=90  elevation=15 ]  median-blur abyss-policy=none  percentile=90  gaussian-blur abyss-policy=none clip-extent=false std-dev-x=4 std-dev-y=4 id=3 screen aux=[ ref=3  emboss  type=bumpmap azimuth=90  elevation=15 ]  median-blur abyss-policy=none  percentile=90 screen aux=[ ref=3  emboss  type=bumpmap azimuth=90  elevation=15 ]  median-blur abyss-policy=none  percentile=90 screen aux=[ ref=3  emboss  type=bumpmap azimuth=90  elevation=15 ]  opacity value=10 median-blur abyss-policy=none radius=0 id=color gimp:layer-mode layer-mode=hsv-hue composite-mode=auto aux=[ ref=color  color value=#3c1200 ] levels in-low=0.250 in-high=1.924 out-low=0.056 out-high=0.610 opacity value=4 id=olsn gimp:layer-mode layer-mode=overlay composite-mode=auto opacity=0.16 aux=[ ref=olsn simplex-noise scale=2.31 iterations=1 seed=33  ] median-blur abyss-policy=none radius=0 lb:edgesmooth hue-chroma lightness=5 chroma=-8 median-blur abyss-policy=none radius=2 id=lchhuerecolor gimp:layer-mode composite-mode=auto layer-mode=lch-hue aux=[ ref=lchhuerecolor  color value=#ffca9e ] id=ba gimp:layer-mode layer-mode=burn blend-space=rgb-perceptual opacity=0.16 composite-mode=auto aux=[ ref=ba ] hue-chroma lightness=3 median-blur abyss-policy=none radius=0 bloom strength=50 median-blur abyss-policy=none radius=0 id=anotherhue gimp:layer-mode layer-mode=hsv-hue composite-mode=clip-to-backdrop aux=[ ref=anotherhue color value=#ff8200 ] "\
...
#define g11 \
" transform transform=matrix(0.85676532983779907,-0.083190269768238068,-1.0763975295356106e-19,0.15398488938808441,1.0494217872619629,-2.1621131194246602e-19,35.636863708496094,106.15763092041016,1)   sampler=nohalo gegl:color-overlay value=#dbdbdb svg:src-atop aux=[ noise-solid levels in-low=-0.4        gimp:layer-mode layer-mode=grain-merge composite-mode=clip-to-backdrop aux=[ color value=#07ff00  ] ]  crop gaussian-blur abyss-policy=none clip-extent=false emboss  type=bumpmap azimuth=30 elevation=45 depth=12 gegl:dropshadow x=0.00  y=0 radius=0.00 grow-shape=circle grow-radius=1 opacity=1 color=#ffffff gegl:dropshadow x=0.00  y=0 radius=0.00 grow-shape=circle grow-radius=6 opacity=1 color=#ffffff gegl:dropshadow x=0.00  y=0.00 radius=0.00 grow-shape=circle grow-radius=6 opacity=1 color=#000000 gegl:dropshadow opacity=0.4 radius=0.1 x=-1.8 y=2.8 gegl:long-shadow style=finite angle=152.94 length=11 midpoint=100 midpoint-rel=0.5 color=#000000 composition=shadow-plus-image median-blur radius=0 abyss-policy=none   "\




#define g12 \
" transform transform=matrix(1.0156650757686598,0.075701741929592628,0.000365746118200971,0.013317261513591921,1.2296272065975005,9.0806881192612718e-05,0,0,1)   sampler=nohalo sampler=nohalo gegl:color-overlay value=#dbdbdb svg:src-atop aux=[ noise-solid levels in-low=-0.4       gimp:layer-mode layer-mode=grain-merge composite-mode=clip-to-backdrop aux=[ color value=#07ff00  ] ]  crop gaussian-blur abyss-policy=none clip-extent=false emboss  type=bumpmap azimuth=30 elevation=45 depth=12 gegl:dropshadow x=0.00  y=0 radius=0.00 grow-shape=circle grow-radius=1 opacity=2 color=#ffffff gegl:dropshadow x=0.00  y=0 radius=0.00 grow-shape=circle grow-radius=6 opacity=1 color=#ffffff gegl:dropshadow x=0.00  y=0.00 radius=0.00 grow-shape=circle grow-radius=6 opacity=1 color=#000000 gegl:dropshadow opacity=0.4 radius=0.1 x=-1.8 y=2.8 gegl:long-shadow style=finite angle=172.94 length=11 midpoint=100 midpoint-rel=0.5 color=#000000 composition=shadow-plus-image median-blur radius=0 abyss-policy=none   "\
