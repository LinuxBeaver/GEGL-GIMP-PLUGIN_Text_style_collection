...
id=first2
plus aux=[ ref=first2 emboss depth=85 elevation=13 azimuth=94 opacity value=3.9 ]
median-blur radius=0
 id=ig alien-map cpn-1-frequency=15 cpn-2-frequency=23 cpn-2-frequency=3 gimp:desaturate mode=average hue-chroma lightness=-13 opacity value=9.0 id=color gimp:layer-mode layer-mode=hsl-color composite-mode=auto opacity=0.025  composite-mode=auto  aux=[ ref=color color-overlay value=#ffec2b box-blur radius=30 ] noise-reduction iterations=3 gimp:layer-mode layer-mode=grain-merge opacity=0.54 composite-mode=auto aux=[ ref=ig lb:innerglow radius=14 value2=#ffeb2b gaussian-blur std-dev-x=5 std-dev-y=5 ] levels in-low=0.032 id=shadow gimp:layer-mode layer-mode=behind opacity=0.033 aux=[ ref=shadow color-overlay value=#000000 gaussian-blur std-dev-x=5 std-dev-y=5 clip-extent=false abyss-policy=none  translate x=6 y=15  ] saturation scale=1.00 lb:threshold-alpha alphadegree=0.7 median-blur radius=0 id=ee gimp:layer-mode layer-mode=subtract opacity=0.07 aux=[ ref=ee lb:edge-extract edgeamount=10.0 threshold=0.76  ] id=et gimp:layer-mode layer-mode=subtract opacity=0.015 aux=[ ref=et  lb:embosstexture ] median-blur radius=0 id=sg gimp:layer-mode layer-mode=normal opacity=0.25 aux=[ ref=sg softglow brightness=0.45 ] bloom strength=20 id=dog gimp:layer-mode  layer-mode=grain-merge opacity=0.19 aux=[ ref=dog difference-of-gaussians ]
